...
function RelayServer(serviceName, serviceToken){
...
//	console.log("relayService:",relayService);
	...
	function websocketInModule(){
		var socket;
		function open(channelName){
			var channelNumber = crc16(channelName);
			socket = new WebSocket('wss://connect.websocket.in/v3/' + channelNumber + '?apiKey=' + serviceToken);
